...
L2_1 = "Yvelt:refreshClientSideRanks"
L1_1(L2_1)
...
function L1_1()
  ...
  function L3_2(A0_3)
    ...
    if L1_3 then
      ...
      L1_3 = L1_3.Async
      L1_3 = L1_3.execute
      L2_3 = "INSERT INTO yvelt_ranks (label, `rank`, perms, power, color) VALUES (@label, @rank, @perms, @power, @color)"
      L3_3 = {}
      L3_3["@label"] = "Owner"
      L3_3["@rank"] = "owner"
      L3_3["@perms"] = "true"
    ...
    if L4_2 then
      ...
      if L4_2 then
        ...
        if L5_2 then
          ...
          L5_2 = L5_2.Async
          L5_2 = L5_2.execute
          L6_2 = "UPDATE yvelt_players SET `rank` = @rank WHERE identifier = @identifier"
          L7_2 = {}
          L8_2 = YveltHelper
          L9_2 = L8_2
          ...
          L5_2 = L5_2.Async
          L5_2 = L5_2.execute
          L6_2 = "INSERT INTO yvelt_players (identifier, name, `rank`, report_count, report_notes) VALUES (@identifier, @name, @rank, @report_count, @report_notes)"
          L7_2 = {}
          L8_2 = YveltHelper
          L9_2 = L8_2
          L8_2 = L8_2.getIdentifier
    ...
    elseif "user" == L3_2 then
      ...
      if L4_2 then
        ...
        if L5_2 then
          ...
          L5_2 = L5_2.Async
          L5_2 = L5_2.execute
          L6_2 = "DELETE FROM yvelt_players WHERE identifier = @identifier"
          L7_2 = {}
          L8_2 = YveltHelper
          L9_2 = L8_2
          L8_2 = L8_2.getIdentifier
      ...
      if L6_2 then
        ...
        if L6_2 then
          ...
          if L7_2 then
            ...
            L7_2 = L7_2.Async
            L7_2 = L7_2.execute
            L8_2 = "UPDATE yvelt_players SET `rank` = @rank WHERE identifier = @identifier"
            L9_2 = {}
            L10_2 = YveltHelper
            L11_2 = L10_2
            ...
            L7_2 = L7_2.Async
            L7_2 = L7_2.execute
            L8_2 = "INSERT INTO yvelt_players (identifier, name, `rank`, report_count, report_notes) VALUES (@identifier, @name, @rank, @report_count, @report_notes)"
            L9_2 = {}
            L10_2 = YveltHelper
            L11_2 = L10_2
            L10_2 = L10_2.getIdentifier
      ...
      elseif "user" == L5_2 then
        ...
        if L6_2 then
          ...
          if L7_2 then
            ...
            L7_2 = L7_2.Async
            L7_2 = L7_2.execute
            L8_2 = "DELETE FROM yvelt_players WHERE identifier = @identifier"
            L9_2 = {}
            L10_2 = YveltHelper
            L11_2 = L10_2
            L10_2 = L10_2.getIdentifier
...
function L1_1()
  ...
  L0_2 = L0_2.Async
  L0_2 = L0_2.fetchAll
  L1_2 = "SELECT * FROM yvelt_players"
  L2_2 = {}
  function L3_2(A0_3)
    ...
    for L5_3, L6_3 in L1_3, L2_3, L3_3, L4_3 do
      ...
      if L7_3 then
        ...
        L7_3 = L7_3.Async
        L7_3 = L7_3.execute
        L8_3 = "DELETE FROM yvelt_players WHERE id = @id"
        L9_3 = {}
        L10_3 = L6_3.id
        L9_3["@id"] = L10_3
        function L10_3(A0_4)
...
function L3_1(A0_2, A1_2)
  ...
  if "owner" == L4_2 then
    ...
    if L4_2 then
      ...
      L4_2 = L4_2.Async
      L4_2 = L4_2.execute
      L5_2 = "UPDATE yvelt_ranks SET power = @power, color = @color, label = @label, perms = @perms WHERE `rank` = @rank"
      L6_2 = {}
      L7_2 = A0_2.rank
      L6_2["@rank"] = L7_2
      L7_2 = A0_2.power
...
function L3_1(A0_2, A1_2)
  ...
  if "owner" == L4_2 then
    ...
    if L4_2 then
      ...
      L4_2 = L4_2.Async
      L4_2 = L4_2.execute
      L5_2 = "INSERT INTO yvelt_ranks (label, `rank`, perms, power, color) VALUES (@label, @rank, @perms, @power, @color)"
      L6_2 = {}
      L7_2 = A0_2.label
      L6_2["@label"] = L7_2
      L7_2 = A0_2.rank
    ...
    L4_2 = DropPlayer
    L5_2 = source
    L6_2 = "YveltShield : Tentative de triche (bypass trigger : \"Yvelt:createNewRank\")"
    L4_2(L5_2, L6_2)
  end
end
L1_1(L2_1, L3_1)
